...
echo.                                                                            ╔════════════════════════════════════════════════════╗
echo.                                                                            ║                                                    ║
echo.                                                                            ║     %w%     Checando privilégios de Admin...        %b%  ║
echo.                                                                            ║                                                    ║
echo.                                                                            ╚════════════════════════════════════════════════════╝
...
echo. 
echo.                                                    %b%═══════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                                                           %W% O otimizador não foi executado como administrador!
echo.
echo.
echo.                                                                                           %W% Para sair, pressione X  
echo.                                                    %b%═══════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
...
echo.                                                                        %b%═══════════════════════════════════════════════════════
echo.
echo.                                                                        %w%   Pressione qualquer tecla para iniciar o otimizador
echo.
echo.                                                                        %b%═══════════════════════════════════════════════════════
echo. 
echo. 
...
echo.        
echo.                                           %b%══════════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                                                %w% Deseja criar um ponto de restauração?                                 
echo.                                                                                                                                                                 
echo.                                                                                                                                                                 
echo.                                               %p%[%w%1%p%]%w% Criar um ponto de restauração                                            %p%[%w%2%p%]%w% Pular                                   
echo.                                                                                                                                                                 
echo.                                                                                                                                                                 
echo.                                           %b%══════════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
echo. 
...
cls 
echo.
echo. %w% Criando um ponto de restauração... ( %b%                                                       
chcp 437 >nul
powershell "Checkpoint-Computer -Description 'Ponto de restauracao Otimizador cosTzin'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 
cls
goto :resources

:resources
::making cosTzin folder
md C:\cosTzin
cls 
...
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "%temp%\cosTzin.zip" "https://github.com/KayoCosta/otimizador/raw/refs/heads/main/8.0.zip" 




Powershell -NoProfile Expand-Archive '%temp%\cosTzin.zip' -DestinationPath 'C:\cosTzin' >nul 2>&1 
cls

powershell "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded resources successfully, Press "OK" To continue to the menu! ', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
echo.                                                                                  %b%║    %w% * Operação Completa * Pressione uma tecla...              %b%║
echo.                                                                                  %b%╚═══════════════════════════════════════════════════════════════╝
echo.
pause > nul
cls
...
echo.
echo.                                                                                                                           
echo.                                                  %p%[%w%1%p%]%w% Otimizações Gerais do Sistema        %p%[%w%2%p%]%w% Otimizações de Energia                %p%[%w%3%p%]%w% Mouse e Teclado
echo. 
echo.                                                  %p%[%w%4%p%]%w% Otimizações da GPU                   %p%[%w%5%p%]%w% Otimizações do CPU                    %p%[%w%6%p%]%w% Limpeza          
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%7%p%]%w% Debloat do Sistema                   %p%[%w%8%p%]%w% Armazenamento                         %p%[%w%9%p%]%w% Memória
echo.                                                                                                                                                                                 
echo.                                                  %p%%p%%p%%p%                                         %p%[%w%10%p%]%w% Aprimoramentos da Internet           
echo.                                                                                                                                                                                 
echo.
echo.                                        %b%════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%F%p%]%w% Corrigir                                %p%[%w%P%p%]%w% Usar Ponto de Restauração
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%R%p%]%w% Reverter                                %p%[%w%X%p%]%w% Sair do utilitário                    
echo.                 
echo.                                        %b%════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.
echo.
...
echo %w% - Loading ...%b%
cls 
md C:\cosTzin >nul 2>&1
echo %w% - Refreshing exm resource folder %b%
timeout /t 1 /nobreak > NUL
del /s /q C:\cosTzin  >nul 2>&1
...
cls
echo.                                               
echo.                                                     Se preferir optar por reverter tudo, recomenda-se utilizar o ponto de restauração
echo.
echo.                                                                            %p%[%w%A%p%]%w% Reverter tudo                              
echo.
echo.                
echo.                                                                       %p%[%w%1%p%]%w% Reverter Categoria Geral                               
echo.                                                                                                                          
echo.                                                                       %p%[%w%2%p%]%w% Reverter Mouse e Teclado                               
echo.                                                                                                                      
echo.                                                                       %p%[%w%4%p%]%w% Reverter Memória                                               
echo.                                                                                                                        
echo.                                                                       %p%[%w%5%p%]%w% Reverter GPU                                      
echo.                                                                                                                       
echo.                                                                       %p%[%w%6%p%]%w% Reverter CPU     
echo.
echo.                                                                       %p%[%w%7%p%]%w% Reverter Energia
echo.
echo.                                                                       %p%[%w%8%p%]%w% Reverter Debloat
echo.
echo.                                                                       %p%[%w%9%p%]%w% Reverter Armazenamento
echo.
echo.                                                                       %p%[%w%10%p%]%w% Reverter Network Utility 
echo.
echo.                                                                       %p%[%w%11%p%]%w% Reverter Uninstall
echo.

echo.                                                                            %p%[%w%M%p%]%w% Voltar para o Menu                                         
echo.                                                                              
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Certifique-se de reiniciar seu PC para que os ajustes sejam aplicados corretamente. Pressione "ok" para sair', 'cosTzin Otimizador', 'ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
pause > nul
cls
...
cls
echo.      
echo.                                                                             %p%[%w%1%p%]%w% Desinstalar aplicativos pré-instalados   
echo.  
echo.                                                                             %p%[%w%2%p%]%w% Desinstalar aplicativos não utilizados
echo.
echo.                                                                             %p%[%w%3%p%]%w% Desinstalar Microsoft edge
echo.
echo.                                                                             %p%[%w%4%p%]%w% Desinstalar Cortana / Copilot
echo.
echo.
...
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════%w%
echo.                                                
echo.                                                    %p%[%w%1%p%]%w% Desinstalar microsoft edge        %p%[%w%2%p%]%w% Instalar microsoft edge
echo.                                                                                 
echo.   
echo.                                                                        %p%[%w%M%p%]%w% Pular e voltar para o Menu   
echo.
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════%w%
echo. 
echo. 
...
:edgingon
echo %w% - Reinstalling Microsoft edge %g%(Pode não funcionar 100% das vezes, se não funcionar, use um ponto de restauração) %b%
chcp 437 >nul 
...
echo.
echo.    
echo.                                                                               %p%%w%%p%%w%                %p%[%w%A%p%]%w% Aplicar aprimoramentos %g%
echo.         

echo.
echo.                                              %b%════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%w% 
echo. 
echo.                                                           %p%[%w%R%p%]%w% Reverter tudo                                          %p%[%w%M%p%]%w% Voltar para o Menu                                                     
echo.
echo.
echo.                                               %b%════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%w% 
echo.                                                                 
...
echo.
echo %w% - Configuring TCP settings and MTU with netsh %g%(mostrará um erro em 2 deles se você tiver wifi ou ethernet desabilitado)%b%
...
echo.                                        %b%════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                                                           
echo.                                                           %p%[%w%1%p%]%w% Desfragmentar Unidades     
echo. 
echo.                                                           %p%[%w%2%p%]%w% Habilitar cache de gravação do usuário  
echo. 
echo.                                                           %p%[%w%3%p%]%w% Otimizar NFTS    
echo.                                                                                
echo.                                                           %p%[%w%4%p%]%w% Desabilitar economia de energia do SSD %g%(SSD only)
echo.
echo.                                                           %p%[%w%5%p%]%w% Otimizar as configurações do FUSTIL %g%(SSD only)
echo.  
echo.
echo.                                                                                           
echo.                                                                       %p%[%w%M%p%]%w% Voltar para o Menu        
echo.                      
echo.                                                                       %p%[%w%R%p%]%w% Reverer       
echo.  
echo.                                        %b%════════════════════════════════════════════════════════════════════════════════
echo.                                         %W% Desfragmente seu driver e aplique algumas otimizações extras de armazenamento
echo.                                        %b%════════════════════════════════════════════════════════════════════════════════
echo. 
set /p input=:
...
:s1
echo %w% - Trimming/Defragmenting Boot Drive %G%(Se demorar muito, fique à vontade para fechar o utilitário e pular esta etapa, os ajustes serão salvos se você fechar para que você possa começar de onde parou) %b%
...
:7war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Nota: Se voce quiser reverter alguma coisa, voce pode faze-lo em nossa categoria de reversao na pagina principal do utilitario', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                                                                                                        
echo.                                                  %p%[%w%1%p%]%w% Desabilitar GameDVR e XBOX                %p%[%w%2%p%]%w% Desativar Telemetry                        
echo.
echo.                                                  %p%[%w%3%p%]%w% Bluetooth                                 %p%[%w%4%p%]%w% Desativar impressão e mapas
echo.   
echo.                                                  %p%[%w%5%p%]%w% Mitigations                               %p%[%w%6%p%]%w% Desabilitar diagnóstico e relatórios de erros                          
echo.                                                                                                                               
echo.                                                  %p%[%w%7%p%]%w% Microsoft Store                           %p%[%w%8%p%]%w% Desativar Hyper-V  
echo.
echo.                                                  %p%[%w%9%p%]%w% Desativar aplicativos de inicialização    %p%[%w%10%p%]%w% Windows Update Blocker
echo.
echo.                                                  %p%[%w%11%p%]%w% Desabilitar Smart Screen                 %p%[%w%12%p%]%w% Desinstalar aplicativos inúteis 
echo.
echo.                                                                                                                                                    
...
echo.
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════════════════════
echo.                                                             %w% Desinstala e desabilita recursos inúteis
echo.                                               %w% Remove bloatware do sistema que é executado em segundo plano e ocupa recursos 
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
echo.                                            
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Depois de pressionar ok, ele abrirá um aplicativo. Vá para a seção LOGON, desabilitando todos os serviços, exceto: antivírus, cmd.exe e os serviços n/a', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1

start C:\cosTzin\Autoruns.exe
echo.
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Nota: Desabilitar as atualizacoes do Windows quebrara a loja da Microsoft. Se você quiser usa-la novamente, basta pressionar "Habilitar" no bloqueador de atualizacoes do Windows.', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
start C:\cosTzin\Windows_Update_Blocker.exe
echo. 
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.                                              %b%════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.
echo.                                                        %p%[%w%1%p%]%w% Desativar Bluetooth                  %p%[%w%2%p%]%w% Ativar Bluetooth %g%(default)
echo.
echo.
echo.                                                        %p%%p%%p%%p%                       %p%[%w%M%p%]%w% Voltar ao Menu  
echo. 
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                           Desative o bluetooth se não o usar, mas se o usar, mantenha-o ativado                                               
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
...
echo.                                              %b%════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.
echo.                                                        %p%[%w%1%p%]%w% Desativar Mitigations                   %p%[%w%2%p%]%w% Ativar Mitigations %g%(reverter)
echo.
echo. 
echo.                                                       %p%%p%%p%%p%                           %p%[%w%M%p%]%w% Voltar ao Menu 
echo. 
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                  As mitigations são proteções contra ataques baseados em memória, mas têm um custo de desempenho
echo.                                                  Desabilita vários recursos básicos que causam perda de desempenho, mas não são tão importantes
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Depois de pressionar ok, ele abrira um aplicativo. Va para a seção LOGON, desabilitando todos os servicos, exceto: antivirus, cmd.exe e os servicos n/a', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Nota: Desabilitar as atualizacoes do Windows quebrara a loja da Microsoft. Se voce quiser usa-la novamente, basta pressionar "Habilitar" no bloqueador de atualizacoes do Windows. ', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                              Você precisa ter atualizações habilitadas para que funcione, a reversão as habilitará
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════%w%
...
echo.                                        %b%═════════════════════════════════════════════════════════════════════════════════════%w%              
echo.                                                                                                                                                                  
echo.                                                                %p%[%w%1%p%]%w% Traga de volta os planos de energia padrão                                
echo.                                                                                                                          
echo.                                                                %p%[%w%2%p%]%w% Reinstalar aplicativos padrão do Windows                                
echo.                                                                                                                      
echo.                                                                %p%[%w%3%p%]%w% Habilitar serviços do XBOX                                         
echo.                                                                                                                      
echo.                                                                %p%[%w%4%p%]%w% Habilitar GameDVR                                                 
echo.                                                                                                                         
echo.                                                                %p%[%w%5%p%]%w% Habilitar notificações                                          
echo.                                                                                                                       
echo.                                                                %p%[%w%6%p%]%w% Habilitar Bluetooth     
echo.
echo.                                                                %p%[%w%7%p%]%w% Habilitar serviços de impressão e mapas
echo.  
echo.                                                                %p%[%w%8%p%]%w% Reinstalar o Edge
echo.     
echo.                                                                %p%[%w%9%p%]%w% Habilitar atualizações do Windows
echo.
echo.                                                                %p%[%w%10%p%]%w% Habilitar Windows Smart Screen
echo.
echo.                                                                %p%[%w%11%p%]%w% Habilitar diagnóstico
echo.
echo.                                                                %p%[%w%12%p%]%w% Habilitar Biometria
echo.
echo.
echo.                                                                                                                       
echo.                                                                  %p%[%w%M%p%]%w% Voltar ao Menu                                         
echo.                                                                              
echo.                                        %b%═════════════════════════════════════════════════════════════════════════════════════
echo.                                                  %W% Permite que você reverta várias configurações, sem precisar usar um ponto de restauração
echo.                                        %b%═════════════════════════════════════════════════════════════════════════════════════
echo.
set /p input=:
...
:5war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('NAO faca isso se o seu PC tiver problemas graves de superaquecimento', 'cosTzin Otimizador', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
echo.                                        %b%════════════════════════════════════════════════════════════════════%w%
echo.                                                                                                                                                                                                                       
echo.                                                      %p%[%w%1%p%]%w% Aplicar otimizações para CPUs AMD          
echo.
echo.                                                      %p%[%w%2%p%]%w% Aplicar otimizações para CPUs INTEL                                             
echo.                                                                                           
echo.                                                                                             
echo.                                                                %p%[%w%T%p%]%w% Abra o Gerenciador de Tarefas                          
echo.                                                                                           
echo.                                                                %p%[%w%M%p%]%w% Voltar ao Menu   
echo.
echo.                                                                %p%[%w%R%p%]%w% Reverter                     
echo.                                                                             
echo.                                        %b%════════════════════════════════════════════════════════════════════%w%
echo.                                                          %w% Selecione o tipo de CPU que você tem:  
echo.          
echo.                                           %w% Desabilite recursos de economia de energia, desabilite o estacionamento principal e muito mais!
echo.                                        %b%════════════════════════════════════════════════════════════════════%w%
echo.
...
echo.                                        %b%═══════════════════════════════════════════════════════════%w%  
echo.                                                                          
echo.                                                     %p%[%w%1%p%]%w% Reverter otimizações de GPU NVIDIA                             
echo.                                                                                            
echo.                                                     %p%[%w%2%p%]%w% Reverter otimizações de GPU AMD                                
echo.                                                                                          
echo.                                                     %p%[%w%3%p%]%w% Reverter otimizações de GPU Intel                          
echo.                                                                     
echo.                                                                                                                                                                                                          
echo.                                                             %p%[%w%M%p%]%w% Voltar ao Menu   
echo.                           
echo.                                        %b%═════════════════════════════════════════════════════════════
echo.                                                     %w% Selecione qual tipo de GPU você tem:
echo. 
echo.                                               %W%  Reverte ajustes de GPU feitos pelo otimizador
echo.                                        %b%═════════════════════════════════════════════════════════════
echo.
set /p input=:
...
echo.                                        %b%═══════════════════════════════════════════════════════════%w%  
echo.                                                                          
echo.                                                     %p%[%w%1%p%]%w% Aplicar otimizações de GPU NVIDIA                            
echo.                                                                                            
echo.                                                     %p%[%w%2%p%]%w% Aplicar otimizações de GPU AMD                                
echo.                                                                                          
echo.                                                     %p%[%w%3%p%]%w% Aplicar otimizações de GPU Intel                          
echo.                                                                     
echo.                      
echo.                                                             %p%[%w%T%p%]%w% Abra o Gerenciador de Tarefas   
echo.
...
echo.                                                     %w% Selecione qual tipo de GPU você tem: 
echo. 
echo.                                               %W%  Otimiza sua GPU ajustando as configurações 3D
...
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════%w%
echo.                                                
echo.                                                    %p%[%w%1%p%]%w% Aplicar otimizações gerais de registro e janelas
echo. 
echo.                                                                                         
echo.                                                                      %p%[%w%M%p%]%w% Voltar ao Menu   
echo.
...
echo.
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════%w%
echo.                                          %W%Aplica otimizações gerais no registro, configurações do Windows, bcd-edit e muito mais!
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════%w%
echo. 
echo. 
...
echo.                                                              %b%"════════════════════════════════════════════════════════════════════════════════"%w%
echo.      
echo.                                                                  %p%[%w%1%p%]%w% Definir FSE para Windows 11              %p%[%w%2%p%]%w% Definir FSE para Windows 10
echo.
echo.                                                                                                                   
echo.                                                                                           
echo.                                                                     %p%%p%%p%%p%                         %p%[%w%M%p%]%w% Voltar ao Menu
echo.                                                                                          
echo.                                                              %b%"════════════════════════════════════════════════════════════════════════════════"
echo.                                                                    %W% Selecione sua versão do Windows para aplicar a configuração FSO apropriada
echo.                                                              %b%"════════════════════════════════════════════════════════════════════════════════"
echo. 
set /p input=:
...
echo.                                                                %b%════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.
echo.                                                                     %p%[%w%1%p%]%w% Ativar Game Mode %g%(WIN 11)                %p%[%w%2%p%]%w% Desativar Game Mode %g%(WIN 10)
echo.
echo.                           
echo.                                                                     %p%%p%%p%%p%                       %p%[%w%M%p%]%w% Voltar ao Menu    
echo.                                                                             
echo.                                                               %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                                           Recomendamos habilitar o modo de jogo no Windows 11, mas desabilitá-lo no Windows 10                                              
echo.                                                               %b%═════════════════════════════════════════════════════════════════════════════════════════════%w%
...
echo.                                        %b%════════════════════════════════════════════════════════════════════════════%w%                                           
echo.                                                                     
echo.                                                                      %p%[%w%A%p%]%w% Aplicar tudo 
echo.                                             
echo.                                                            %p%[%w%1%p%]%w% Aplicar Exm Free Power Plan V6              
echo.                                                                                           
...
echo.  
echo.                                                            %p%[%w%6%p%]%w% Desabilitar recursos de economia de energia da GPU
echo. 
echo.      
echo.                                                                       %p%[%w%M%p%]%w% Voltar ao Menu   
echo. 
...
echo.                                                                                      
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════
echo.                                                     %w% Pode aumentar a temperatura da CPU em PCs mal resfriados
echo.                                                  %W% Desabilita vários recursos inúteis de economia de energia e muito mais
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════
echo.
echo.
...
powercfg -import "C:\cosTzin\Exm Free Power Plan V6.pow"
powercfg.cpl
...
echo %w% - Disabling Fast Startup %g%(inicialização rápida é ruim para o seu pc, mesmo que acelere a inicialização em alguns segundos, é por isso que o utilitário o desabilita) %b%
...
echo.                                              %b%════════════════════════════════════════════════════════════════════════════%w%
echo.
echo.                                                    %p%[%w%1%p%]%w% Planos de energia padrão                      %p%[%w%2%p%]%w% Pular
echo.
echo.                                                                                     
echo.                                                    %p%%p%%p%%p%                      %p%[%w%R%p%]%w% Planos de energia padrão 
echo.
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════%w%
echo.                                                  Exclui planos de energia padrão %g%(Equilibrado, economia de energia e alto desempenho)                                              
echo.                                              %b%═════════════════════════════════════════════════════════════════════════════%w%
...
echo.                                        %b%═════════════════════════════════════════════════════%w%  
echo.                                                                          
echo.                                           %p%[%w%1%p%]%w% Habilitar recursos de economia de energia da GPU NVIDIA                             
echo.                                                                                            
echo.                                           %p%[%w%2%p%]%w% Habilitar recursos de economia de energia da GPU AMD                              
echo.                                                                                          
echo.                                           %p%[%w%3%p%]%w% Habilitar recursos de economia de energia da GPU Intel                         
echo.                                                                     
echo.                      
echo.                                                       %p%[%w%T%p%]%w% Abra o Gerenciador de Tarefas                          
echo.                                                                                                                                                                                     
...
echo.                                        %b%══════════════════════════════════════════════════════
echo.                                                 %w% Selecione qual tipo de GPU você tem:
echo.                                                 %W% Habilita recursos de economia de energia da GPU
echo.                                        %b%══════════════════════════════════════════════════════
echo.
set /p input=:
...
echo.                                        %b%═════════════════════════════════════════════════════%w%  
echo.                                                                          
echo.                                           %p%[%w%1%p%]%w% Desabilitar recursos de economia de energia da GPU NVIDIA                            
echo.                                                                                            
echo.                                           %p%[%w%2%p%]%w% Desabilitar recursos de economia de energia da GPU AMD                                
echo.                                                                                          
echo.                                           %p%[%w%3%p%]%w% Desabilitar recursos de economia de energia da GPU Intel                           
echo.                                                                     
echo.                      
echo.                                                       %p%[%w%R%p%]%w% Reverter
echo. 
...
echo.     
echo.                                        %b%═════════════════════════════════════════════════════════════════════════════%w%                                           
echo.                                                                  Selecione a quantidade de RAM que você tem:             
echo.                                                                                          
...
echo. 
echo.                                                                                       
echo.                                           %p%%p%%p%%p%                              %p%[%w%T%p%]%w% Abra o Gerenciador de Tarefas  
echo.
echo.                                           %p%%p%%p%%p%                              %p%[%w%M%p%]%w% Voltar ao Menu       
echo.
...
echo.                                                                                   
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════%w% 
echo.                                           %w% Otimiza vários valores de registro relacionados à RAM para desempenho ideal
echo.                                              %W% Desabilita um monte de recursos inúteis que prejudicam seu desempenho
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════%w% 
echo.
echo.
...
start "" /wait "C:\cosTzin\nvidiaProfileInspector.exe" "C:\cosTzin\Free NVPI EXM Profile V7.nip" 
...
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                                
echo.                                                            %p%[%w%1%p%]%w% GPU Hardware Acceleration Off %g%(Recomendado)
echo.  
...
echo.
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════════════%w%
echo.                                 %W%Habilita/Desabilita o agendamento acelerado de hardware da GPU, na maioria dos casos é melhor desabilitar
echo.                                        %b%═══════════════════════════════════════════════════════════════════════════════════════%w%
echo. 
echo. 
...
echo.                                        %b%═══════════════════════════════════════════════════════════════%w%                    
echo.                                                                                          
echo.                                                      %p%[%w%1%p%]%w% Aplicar otimizações do registro KBM     
echo.                                                                                           
echo.                                                      %p%[%w%2%p%]%w% Definir tamanho da fila de dados do KBM  
echo.
echo.                                                      %p%[%w%3%p%]%w% Aplicar otimizações USB
echo.                                                                                          
echo.                                                                                            
echo.                                                              %p%[%w%M%p%]%w% Voltar ao Menu 
echo.
...
echo.                                                                                            
echo.                                        %b%════════════════════════════════════════════════════════════════
echo.                                        %w% Otimiza várias configurações de registro relacionadas ao mouse e ao teclado
echo.                                        %b%════════════════════════════════════════════════════════════════
echo.
...
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════════════════════   
echo.                                                                                                                       
echo.                                         %p%[%w%1%p%]%w% 13 %G%(High end)                %p%[%w%2%p%]%w% 18 %g%(Mid end)               %p%[%w%3%p%]%w% 22 %g% (Low end)                 
echo.                                                                                                                                                                                        
echo.                                                                                                                      
echo.                                         %p%%p%%p%%p%                                      %p%[%w%T%p%]%w% Abra o Gerenciador de Tarefas                                    
echo.                                                                                                                       
...
echo.                                                                                          
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════════════════════
echo.                                                      %w% Quanto menor o valor, menor será a latência periférica que você terá
echo.                                         %w% Mas pode causar travamentos e atrasos no KBM em PCs de baixo custo se o valor for muito alto
echo.                                        %b%══════════════════════════════════════════════════════════════════════════════════════════════
echo.
set /p input=: 
...
echo.                                                                                    
echo.                                        %b%═══════════════════════════════════════════════════════════════════
echo.                                                    %W% Limpa um monte de dados temporários do seu PC
